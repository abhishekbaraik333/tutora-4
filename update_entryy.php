...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['entry_id'])) {
        ...
        // Lier les paramètres
        $stmt->bind_param("ssssssssissi", $name, $prenom, $email, $prestation, $destination, $message, $nbrpassager, $apec , $statut, $phone, $preference , $entry_id);
