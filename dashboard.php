...
$sql_rejected = "SELECT COUNT(*) AS rejected_count FROM submissions WHERE statut = 0";
...
$sql_accepted = "SELECT COUNT(*) AS accepted_count FROM submissions WHERE statut = 1";
...
$sql_pending = "SELECT COUNT(*) AS pending_count FROM submissions WHERE statut != 0 AND statut != 1";
        ...
        <div class="navbar-wrapper">
            <div class="m-header main-logo">
                <a href="#" class="b-brand">
                    ...
                    <img src="Tutora/logo/logo blanc fond transparent.jpg" alt="" class="logo logo-lg" />
                    <img src="Tutora/logo/logo bleu fond transparent.jpg" alt="" class="logo logo-sm" />
                                                    ...
                                                    <td
                                                        ...
                                                        <div class="action-btn ms-2 me-3">
                                                            <form id="deleteForm" method="POST"
                                                                action="delete_submission.php" accept-charset="UTF-8">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body d-flex flex-column">
                                                                ...
                                                                <p><strong>Adresse:</strong>
                                                                    <?= $row['prestation'] ?></p>
                                                                <p><strong>matiere:</strong>
                                                                    <?= $row['destination'] ?></p>
                                                                <p><strong>Message:</strong> <?= $row['message'] ?></p>
                                                                <p><strong>Format :</strong>
                                                                    <?= $row['nbrpassager'] ?></p>
                                                                <p><strong>Niveau:</strong> <?= $row['apec'] ?></p>
                                                                ...
                                                                <form method="POST" action="update_entry.php">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label for="destination"
                                                                            class="form-label">Matiére</label>
                                                                        <input type="text" class="form-control"
